...
local function open_cheatsheet(cursor_line)
  ...
  if narrow then
    ...
    win = vim.api.nvim_open_win(buf, true, {
      ...
      style = "minimal",
      border = "rounded",
      title = " Writer Neovim Cheat Sheet ",
      title_pos = "center",
      zindex = 60,
    })
  else
...
local cheatsheet_group = vim.api.nvim_create_augroup("WriterCheatsheet", { clear = true })
...
map("n", "<leader>?", toggle_cheatsheet, { desc = "Toggle writing cheat sheet" })
